...
import { meridian, parallel } from '../geom/flat/geodesic.js';  //hacked to allow to pass the grid projection
/**
 * @type {Stroke}
 * @private
 * @const
...
var Graticule = /** @class */ (function (_super) {
    ...
    function Graticule(opt_options) {
         ...
         * @private
         */
        _this.gridProjection = (options.projection === undefined)?       getProjection('EPSG:4326'):   //default WGS84;
                               (typeof options.projection === "string")? getProjection(options.projection):
                                                                         options.projection;
        /**
         * @type {number}
         * @private
    ...
    Graticule.prototype.getInterval_ = function (resolution) {
        ...
        for (var i = 0, ii = this.intervals_.length; i < ii; ++i) {
            var delta = clamp(this.intervals_[i] / 2, 0, this.maxLat_);
            // Don't attempt to transform latitudes beyond the poles!
            var clampedLat = clamp(centerLat, this.minLat_ + delta, this.maxLat_ - delta);
    ...
    Graticule.prototype.getMeridian_ = function (lon, minLat, maxLat, squaredTolerance, index) {
        var flatCoordinates = meridian(lon, minLat, maxLat, this.projection_, squaredTolerance, this.gridProjection);
        var lineString = this.meridians_[index];
        if (!lineString) {
    ...
    Graticule.prototype.getParallel_ = function (lat, minLon, maxLon, squaredTolerance, index) {
        var flatCoordinates = parallel(lat, minLon, maxLon, this.projection_, squaredTolerance, this.gridProjection);
        var lineString = this.parallels_[index];
        if (!lineString) {
            lineString = new LineString(flatCoordinates, GeometryLayout.XY);
        }
    ...
    Graticule.prototype.updateProjectionInfo_ = function (projection) {
        var worldExtent = this.gridProjection.getExtent();
        ...
        var toLonLatTransform = getTransform(projection, this.gridProjection);
