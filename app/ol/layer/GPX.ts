...
import { def_trk_color, isTrkFeature, isWptFeature, olWptFeature, olTrackFeature, getTrkptIndices, createGpxText } from '../gpx-common';

import { getSymbol } from '../../sym'
import { getEpochOfCoord, companionColor, getLocalTimeByCoord } from '../../common';
